...
|---|---|---|---|
| `supabase/tests/rechte-test.sql` | 106 Angriffe/erlaubte Aktionen, jede Rolle | Supabase → SQL Editor | nein (alles zurückgerollt) |
...
Oben steht die Summe. Erwartet: `114 ok / 0 Abweichungen / 0 unklar / 1 Hinweise`.
